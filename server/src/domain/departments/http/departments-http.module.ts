...
import { CreateDepartmentUseCase } from '../use-cases/create/create-department'
import { FindDepartmentByIdUseCase } from '../use-cases/find/by-id/find-department-by-id'
import { FindDepartmentByNameUseCase } from '../use-cases/find/by-name/find-department-by-name'
