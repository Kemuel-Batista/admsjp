...
exports.ListEventPurchasesByUserIdUseCase = void 0;
...
let ListEventPurchasesByUserIdUseCase = class ListEventPurchasesByUserIdUseCase {
    ...
    async execute({ buyerId, }) {
        ...
        const eventPurchases = await this.eventPurchasesRepository.listByBuyerId(buyerId);
        return (0, either_1.success)({
            eventPurchases,
        });
    }
};
exports.ListEventPurchasesByUserIdUseCase = ListEventPurchasesByUserIdUseCase;
exports.ListEventPurchasesByUserIdUseCase = ListEventPurchasesByUserIdUseCase = __decorate([
...
//# sourceMappingURL=list-event-purchases-by-user-id.js.map