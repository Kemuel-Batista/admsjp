...
exports.CreateEventLotUseCase = void 0;
...
let CreateEventLotUseCase = class CreateEventLotUseCase {
    eventLotsRepository;
    eventsRepository;
    ...
    async execute({ name, description, eventId, quantity, status = 1, value, createdBy, }) {
        ...
        const maxEventLot = await this.eventLotsRepository.findMaxLotByEventId(eventId);
...
exports.CreateEventLotUseCase = CreateEventLotUseCase;
exports.CreateEventLotUseCase = CreateEventLotUseCase = __decorate([
...
//# sourceMappingURL=create-event-lot.js.map