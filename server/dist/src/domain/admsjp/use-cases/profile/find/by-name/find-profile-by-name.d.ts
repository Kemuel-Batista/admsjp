...
export declare class FindProfileByNameUseCase {
    private profilesRepository;
    constructor(profilesRepository: ProfilesRepository);
    execute<Options extends IFindOptions>(name: Profile['name'], options?: IFindOptions): Promise<TFindProfileByIdUseCase<Options>>;
}
export {};
