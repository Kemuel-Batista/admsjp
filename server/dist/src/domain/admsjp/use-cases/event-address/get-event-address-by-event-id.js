...
exports.GetEventAddressByEventIdUseCase = void 0;
...
let GetEventAddressByEventIdUseCase = class GetEventAddressByEventIdUseCase {
    ...
    async execute({ eventId, }) {
        ...
        const eventAddress = await this.eventAddressesRepository.findByEventId(eventId);
        if (!eventAddress) {
            return (0, either_1.failure)(new resource_not_found_error_1.ResourceNotFoundError({
...
exports.GetEventAddressByEventIdUseCase = GetEventAddressByEventIdUseCase;
exports.GetEventAddressByEventIdUseCase = GetEventAddressByEventIdUseCase = __decorate([
...
], GetEventAddressByEventIdUseCase);
//# sourceMappingURL=get-event-address-by-event-id.js.map