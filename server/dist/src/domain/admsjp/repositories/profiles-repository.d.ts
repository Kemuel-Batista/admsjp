...
import { CreateProfileDTO, ListProfileDTO, UpdateProfileDTO } from '../dtos/profile';
export declare abstract class ProfilesRepository {
    ...
    abstract list(options?: IListOptions, searchParams?: ISearchParamDTO[]): Promise<ListProfileDTO>;
