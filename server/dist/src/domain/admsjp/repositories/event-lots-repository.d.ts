...
export declare abstract class EventLotsRepository {
    abstract create(data: Prisma.EventLotUncheckedCreateInput): Promise<EventLot>;
    abstract save(data: EventLot): Promise<EventLot>;
    abstract list(options?: IListOptions, searchParams?: ISearchParamDTO[]): Promise<ListEventLotsDTO>;
    abstract listByEventId(eventId: EventLot['eventId'], options?: IListOptions, searchParams?: ISearchParamDTO[]): Promise<ListEventLotsDTO>;
