...
const DeleteEventParamsSchema = zod_1.z.coerce.number().int().positive();
const paramValidationPipe = new zod_validation_pipe_1.ZodValidationPipe(DeleteEventParamsSchema);
let DeleteEventController = class DeleteEventController {
    deleteEvent;
...
], DeleteEventController.prototype, "handle", null);
exports.DeleteEventController = DeleteEventController = __decorate([
    (0, common_1.Controller)('/:eventId'),
    __metadata("design:paramtypes", [delete_event_1.DeleteEventUseCase])
], DeleteEventController);
//# sourceMappingURL=delete-event.controller.js.map