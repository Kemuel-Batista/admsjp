...
exports.ListProfileController = void 0;
...
let ListProfileController = class ListProfileController {
    listProfileUseCase;
    constructor(listProfileUseCase) {
    ...
    async handle(query, user, request, response) {
        ...
        const { profiles, count } = await this.listProfileUseCase.execute(options, parsedSearch, user.sub.profileId);
        response.setHeader('X-Total-Count', count);
        return response.status(common_1.HttpStatus.OK).json(profiles);
    }
};
exports.ListProfileController = ListProfileController;
__decorate([
...
], ListProfileController.prototype, "handle", null);
exports.ListProfileController = ListProfileController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [list_profile_1.ListProfileUseCase])
], ListProfileController);
//# sourceMappingURL=list-profile.controller.js.map